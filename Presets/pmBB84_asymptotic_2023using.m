...
function [protocolDescription,channelModel,leakageEC,parameters,solverOptions] = pmBB84_asymptotic_2023using()
...
function [protocolDescription,channelModel,leakageEC]=setDescription()
    ...
    protocolDescription=str2func('pmBB84Description_2023using');
...
function parameters=setParameters()
    ...
    parameters.scan.eta = 0.2; %channel transmittance 信道透射率
...
%     solverOptions.optimizer.name = 'localSearch_Adam';
    solverOptions.optimizer.linearResolution = 5; 
    ...
    solverOptions.solver1.initmethod = 2; 
