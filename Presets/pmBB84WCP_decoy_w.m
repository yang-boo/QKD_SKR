...
function [protocolDescription,channelModel,leakageEC,parameters,solverOptions] = pmBB84WCP_decoy_w()
...
function [protocolDescription,channelModel,leakageEC]=setDescription()
    ...
    channelModel=str2func('pmBB84WCPChannel_w'); %contains asymptotic decoy state analysis in file
